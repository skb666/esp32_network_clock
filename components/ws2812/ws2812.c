...
void ws2812_init(void) {
    ...
    rmt_set_gpio((rmt_channel_t)RMTCHANNEL, RMT_MODE_TX, WS2812_PIN, 0);
...
void ws2812_setColor(rgbVal color) {
    rgbVal *pixels = malloc(sizeof(rgbVal));
    pixels[0] = color;
